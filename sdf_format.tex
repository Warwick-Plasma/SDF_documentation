...
%\endfoot
  ...
  48 & int 8 & first\_block\_location & The location of the first metadata
...
\begin{tabularx}{0.9\textwidth}[!hbt]{cclX}
  ...
  56 & int 8 & summary\_location & The location of the first metadata
...
\begin{tabularx}{0.9\textwidth}[!hbt]{lcX}
  ...
  c\_blocktype\_particle\_family & 13 & Information about a particle family.
\end{tabularx}
\end{center}\vspace{10pt}
...
\subsection{c\_blocktype\_plain\_mesh and c\_blocktype\_point\_mesh}
...
\subsection{c\_blocktype\_plain\_variable and c\_blocktype\_point\_variable}
...
\subsection{c\_blocktype\_run\_info}
...
\subsection{c\_blocktype\_stitched\_tensor, \_material, \_matvar and \_species}
...
is to be defined.
For a ``c\_blocktype\_stitched\_tensor'' block, the metadata to be written
is as follows:\\
